...
var (
	...
	InfoEnvironmentBaseDirectory = errors.New("Will create new environment environment at ")
	...
	// ErrPullingAssetsFromGit
	ErrPullingAssetsFromGit = errors.New("Failed to pull assets from git. ")

	// ErrInstallBashScriptNotFound
	ErrInstallBashScriptNotFound = errors.New("Failed to find install bash script. ")
	...
	// ErrRunBashDependencyInstallation
	ErrAppDirDoesNotExist = errors.New("Failed to resolve app directory. Please check if seeder executed ok!")
